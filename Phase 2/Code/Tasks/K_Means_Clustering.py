...
number_clusters = 7
for loca in range(1,len(location_id) + 1):
    for mod in range(0,10):
        ...
        with open('C:\\MWDB Project\\Phase 2\\Code\\CSV\\Task 4_5_Img\\{}.csv'.format(location_id[loca] + " " + models[mod]), 'w', encoding = 'utf8', newline='') as outcsv:   
