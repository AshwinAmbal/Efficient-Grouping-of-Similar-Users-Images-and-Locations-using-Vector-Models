...
with open("C:\\MWDB Project\\Phase 2\\Code\\CSV\\Task 1_2\\devset_textTermsPerPOIEdited.csv", 'w', encoding = 'utf8', newline='') as outcsv:   
...
list_of_lines = list()
csvfile = open("C:\\MWDB Project\\Phase 2\\Code\\CSV\\Task 1_2\\devset_textTermsPerPOIEdited.csv","r", encoding="utf8")
...
with open("C:\\MWDB Project\\Phase 2\\Code\\CSV\\Task 1_2\\TF_IDF_Loc.csv", 'w', encoding = 'utf8', newline='') as outcsv:   
    #configure writer to write standard csv file
