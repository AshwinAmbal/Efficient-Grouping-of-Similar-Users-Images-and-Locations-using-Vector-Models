# -*- coding: utf-8 -*-
"""
Created on Fri Sep 14 15:15:06 2018
...
with open("C:\\MWDB Project\\Phase 1\\Code\\CSV\\Task_1\\TF_User.csv", 'w', encoding = 'utf8', newline='') as outcsv:   
...
with open("C:\\MWDB Project\\Phase 1\\Code\\CSV\\Task_1\\DF_User.csv", 'w', encoding = 'utf8', newline='') as outcsv: 
    #configure writer to write standard csv file
    writer = csv.writer(outcsv, delimiter=',', quotechar = "'")
...
with open("C:\\MWDB Project\\Phase 1\\Code\\CSV\\Task_1\\TF_IDF_User.csv", 'w', encoding = 'utf8', newline='') as outcsv:   
    #configure writer to write standard csv file
    writer = csv.writer(outcsv, delimiter=',', quotechar = "'")
